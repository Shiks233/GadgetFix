...
<body>
  ...
  %>
  		<form method="post" action="AddRepairAmount">
        		<input name="amount" class="form-control p-2 my-2" type="number" min="100" placeholder="Repair Amount" required />
  ...
  %>
  	<a class="btn btn-success btn-sm" href="ChangeGadgetStatus?id=<%=gadget.get("id")%>&status=Repaired&type=repair_expert&email=<%=gadget.get("user_email") %>">Repaired</a>
  <%		
  	}
  %>		
  		</div>
