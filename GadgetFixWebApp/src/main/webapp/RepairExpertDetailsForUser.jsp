...
<body>
  ...
  <section class="container-fluid text-center p-2 bg-dark text-white">
  		<form method="post" action="UserHome.jsp" enctype="multipart/form-data" class="row p-3 align-items-center">
  ...
  <%
	...
	db.closeConnection();
  %>
  		<img style="border-radius:50%;border:2px solid gray;" alt="" src="GetPhoto?type=repair_expert&email=<%=email%>" height="100px">
  		<p>
  ...
  <div class="bg-light p-2 m-2" >
  	<form method="post" action="AddGadget" enctype="multipart/form-data" >
        ...
        <label>Gadget Photo 1:</label> <input class="col-sm m-2" name="photo1" type="file"  required />
        <label>Gadget Photo 2:</label> <input class="col-sm m-2" name="photo2" type="file"  required />
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="AdminLogin">
                ...
                <button class="btn btn-primary my-2" href="UserHome.jsp">Submit</button>
            </form>
        </div>
      </div>
    </div>
