...
<body>
  ...
  %>
  		...
  		%>
  			<a class="btn btn-danger btn-sm" href="ChangeRepairExpertStatus?email=<%= repairExpert.get("email") %>&status=Deactive">Deactivate</a>
  		<%		
  			}else{
		%>
	  		<a class="btn btn-success btn-sm" href="ChangeRepairExpertStatus?email=<%= repairExpert.get("email") %>&status=Active">Activate</a>
	  	<%		
  			}
  		%>
  		</p>
